...
void solve(){
    ...
    //     int f2 = 1;
    //     for(int i = 0; i < n; i++){
    //         if(v[i]%2==1) {cout << 1 << endl; f2 = 0; break; }
    //     }
    //     if(f2) cout << 0 << endl; 
    // }
    // if(m==3){
    ...
    //     for(int i = 0; i < n; i++){
    //         if(v[i]%3==0) threezero++;
    //         else if(v[i]%3==1) threeone++;
    //         else if(v[i]%3==2) threetwo++;
    //     }
    //     if(threezero>0) cout << 0 << endl;
    //     else if(threetwo>0) cout << 1 << endl;
    //     else cout << 2 << endl;
    // }
    // if(m==4){
    //     // int fourdiv = 0; int fourthree = 0;
    //     // for(int i = 0; i < n; i++){
    //     //     if(v[i]%2==0) even++;
    //     //     if(v[i]%4==0) fourdiv++;
    //     //     if(v[i]%4==3) fourthree++;
    //     //     else odd++;
    //     // }
    //     // if(even>=2) cout << 0 << endl;
    //     // else if(even == 1 && fourdiv >= 1) cout << 0 << endl;
    //     // else if(fourthree>0) cout << 1 << endl;
    //     // else cout << 2-even << endl;
    //     int mod_arr[n]; for(int i=0;i<n;i++) mod_arr[i]=v[i]%m;
    //     int ans=m; int ctr2=0, ctr1=0, ctr3=0;
    //     for(auto e : mod_arr) {
    //         if(e==0){
    //             cout<<0<<endl;
    //             return;
    ...
    // }
    // if(m==5){
    //     int fivezero = 0, fivefour=0, fivethree=0, fivetwo = 0, fiveone = 0;
    //     for(int i = 0; i < n; i++){
    //         if(v[i]%5==0) fivezero++;
    //         else if(v[i]%5==1) fiveone++;
    //         else if(v[i]%5==2) fivetwo++;
    //         else if(v[i]%5==3) fivethree++;
    //         else if(v[i]%5==4) fivefour++;
    //     }
    //     if(fivezero>0) cout << 0 << endl;
    //     else if(fivefour>0) cout << 1 << endl;
    //     else if(fivethree>0) cout << 2 << endl;
    //     else if(fivetwo>0) cout << 3 << endl;
    //     else if(fiveone > 0) cout << 4 << endl;
    // }
    ...
    int mod_arr[n];
    for(int i=0;i<n;i++) mod_arr[i]=a[i]%k;
    int ans=k; int ctr2=0, ctr1=0, ctr3=0;
    for(auto e : mod_arr) {
        if(e==0){
            cout<<0<<endl;
            return;
