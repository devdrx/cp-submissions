...
void solve(){
    ...
    //decrease the gap between cnt2 and cnt5 as much as u can, gets u more zeroes
    while(cnt2<cnt5 and k*2<=ku){
            k*=2;
            cnt2++;
    }
    while(cnt5<cnt2 and k*5<=ku){
            k*=5;
            cnt5++;
    }
    while(k*10<=ku){
