...
void solve(){
    ...
    //agar even zeros hai toh alice ko !palindrome krna hin padega , then bob will win as keep reversing and avoiding the situation 
    if(mp['0']%2==0){
        if(mp['0']==0){
            cout<<"DRAW"<<endl;
        }
        ...
        if(mp['0']==1){ //beech mein ek zero ka case
            cout<<"BOB"<<endl;
        }
        else{
            cout<<"ALICE"<<endl;
