...
void solve(){
    ...
    ans.push_back({s[n-1],n});
    sort(ans.begin()+1, ans.end()-1);
    if(!x){
        reverse(ans.begin()+1, ans.end()-1);
    }
    //with this i expect my jumps to happen with either a decreasing or increasing way depending on f < l  
