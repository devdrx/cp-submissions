...
void solve(){
    ...
    if(s[3] == '1') d++;
    // cout << a << " " << b << " " << c << " " << d << endl;
    //if only one variable among a b c d is 1
    if((a == 1 && b == 0 && c == 0 && d == 0) || (a == 0 && b == 1 && c == 0 && d == 0) || (a == 0 && b == 0 && c == 1 && d == 0) || (a == 0 && b == 0 && c == 0 && d == 1)){
        cout << 11 << endl;
    }
    //if only either a and b are set or c and d are set
    else if((a == 1 && b == 1 && c == 0 && d == 0) || (a == 0 && b == 0 && c == 1 && d == 1)){
        cout << 21 << endl;
    }
    //if either a and c or a and d or b and c or b and d are set
    else if((a == 1 && b == 0 && c == 1 && d == 0) || (a == 1 && b == 0 && c == 0 && d == 1) || (a == 0 && b == 1 && c == 1 && d == 0) || (a == 0 && b == 1 && c == 0 && d == 1)){
        cout << 121 << endl;
    }
    //if any three are set
    else if((a == 1 && b == 1 && c == 1 && d == 0) || (a == 1 && b == 1 && c == 0 && d == 1) || (a == 1 && b == 0 && c == 1 && d == 1) || (a == 0 && b == 1 && c == 1 && d == 1)){
        cout << 231 << endl;
    }
    else{
        cout << 441 << endl;
