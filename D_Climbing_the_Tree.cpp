...
void solve(){
    ...
    for(int i = 0; i < n; i++){
        ...
        if(type==1){
            ...
            int a, b; cin >> a >> b;
            //calculate number of days to reach l, if on each day you can go a steps forward and at the end of day u get b steps backward, but the last day if l <= a, u can consider it done
            ans.push_back(9);
        }
    }
