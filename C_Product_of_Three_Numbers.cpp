...
void solve(){
    ...
    int a = 2, b, c;
    while(a*a<=n && n%a!=0){
        //this gives the first factor of n
        a++;
    }
    if(a*a>n){
        //why >?
        //because if a*a==n then a is the last factor of n
        cout<<"NO\n";
        return;
    }
    n/=a;
    b=a+1;
    while(b*b<=n && n%b!=0){
        //this gives the second factor of n
        b++;
    }
    if(b*b>=n){
        //why >= ?
        //because if b*b==n then b is the last factor of n
        cout<<"NO\n";
        return;
    }
    c = n/b;
